...
function Footer() {
  ...
  return (
    <footer className="w-full bg-zinc-800 pt-20 pb-16">
      <div className="max-w-6xl mx-auto grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 px-6 gap-6">
        {/* Tagline & Social */}
        <div className="col-span-3 flex flex-col gap-6 mb-16">
          <h1 className="text-indigo-500 font-display text-3xl uppercase">
            Imagine a place
          </h1>
          <div className="flex justify-start gap-6 items-center text-2xl text-white">
            <a
        ...
        {/* Product */}
        <ul className="flex flex-col md:col-start-5 gap-2 col-span-2 font-body text-sm mb-10">
          ...
          <li>
            <a href={`${baseUrl}/nitro`} className="text-white hover:underline">
              Nitro
            </a>
          </li>
        </ul>
        {/* Company */}
        <ul className="flex flex-col gap-2 col-span-2 font-body text-sm mb-10">
          <li className="text-indigo-500">Company</li>
          <li>
            <a href={`${baseUrl}`} className="text-white hover:underline">
              About
            </a>
          </li>
          <li>
        ...
        {/* Resources */}
        <ul className="flex flex-col md:col-start-5 lg:col-start-auto gap-2 col-span-2 font-body text-sm mb-10">
        ...
        {/* Bottom */}
        <div className="col-span-4 md:col-span-8 lg:col-span-12 flex justify-between border-t border-indigo-600 pt-8">
          {/* Logo */}
          ...
          <Button link="profile" version="accent__small">
            Open Discord
          </Button>
        </div>
      </div>
